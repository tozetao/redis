...
//扩展功能1：投反对票
//如果投票只有1次机会的话，只需要在voted:article_id键判断用户是否投票即可；如果赞票与反对票均有一次机会的话，那么需要俩个集合来文章有哪些用户进行投票。

//扩展功能2：对调投票
//因为有对调投票，所以投票机会应该是只有一次机会比较合适。


//缺点1：这种方式确实可以对所有文章进行排序，并且保证对文章的投票操作是原子性的，但是随着文章的增多，俩个有序集合的元素会增多，存储文章的hash会增多，内存的占用也会增多。

//缺点2：内存中存储的数据什么时候对数据库进行同步
